                    ...
                    if (dat.status == 0) {
                        ...
                        for (var i in dat.data.users) {
                            ...
                            if (dat.data.users[i].floor == 3) {
                                if ((38.24766 < dat.data.users[i].lat) && (dat.data.users[i].lat < 38.2478) && (114.3485 < dat.data.users[i].lng) && (dat.data.users[i].lng < 114.34871)) {
                                    addUserPoint(
                                        dat.data.users[i].id,
                                ...
                                if ((38.24766 < dat.data.users[i].lat) && (dat.data.users[i].lat < 38.2478) && (114.3485 < dat.data.users[i].lng) && (dat.data.users[i].lng < 114.349238)) {
                                    addUserPoint(
                                        dat.data.users[i].id,
                                        dat.data.users[i].uid,
                                        dat.data.users[i].lng,
