...
<script>
    ...
    require([
        ...
        //初始化F1楼层平面图
        var f1 = new DynamicMapServiceLayer("http://121.28.103.199:5567/arcgis/rest/services/C7/c7floor3/MapServer");
        map.addLayer(f1);
        ...
        // --------------------------路径分析-----------------------------------------
        //创建路径分析对象
        var routeAnalyst = new RouteTask("http://121.28.103.199:5567/arcgis/rest/services/C7/network3/NAServer/route");
        //创建路径参数对象
