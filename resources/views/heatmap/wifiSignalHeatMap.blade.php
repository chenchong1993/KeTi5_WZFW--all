...
<div class="nav" style="z-index: 5; position: fixed ;right:16%;top: 7%">
    <ul class="nav1" style="margin-top:0">
        <li class="li1 caozuo"><a href="">转到其他地图</a>
            <ul class="nav2">
                <li class="li2"><a href="{{url('bluSignalHeatMap')}}">蓝牙</a>
                </li>
                <li class="li2"><a href="{{url('wifiSignalHeatMap')}}">WIFI</a>
                </li>
            </ul>
        </li>
    </ul>
...
<div class="row">
    ...
    <div class="map2-col">
        <div id="map2"></div>
        <h2 class="menu-btn" style="left: 43%;font-size: 35px;color: #0c0c0c;top: 10px">WIFI</h2>
    </div>
    <div class="map3-col">
        <div id="map3"></div>
    </div>
