...
<script>
    ...
    require([
        ...
        //初始化F1楼层平面图
        var f1 = new DynamicMapServiceLayer("http://121.28.103.199:5567/arcgis/rest/services/331/floortwo/MapServer");
        map.addLayer(f1);
        ...
        // --------------------------路径分析-----------------------------------------
        //创建路径分析对象
        var routeAnalyst = new RouteTask("http://121.28.103.199:5567/arcgis/rest/services/331/network2/NAServer/route");
        //创建路径参数对象
